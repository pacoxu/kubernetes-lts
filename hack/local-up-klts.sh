...
gcr.io/k8s-staging-test-infra/krte:v20211217-ea95cec1d4-master wrapper.sh bash -c "curl -sSL https://kind.sigs.k8s.io/dl/latest/linux-amd64.tgz | tar xvfz - -C \"${PATH%%:*}/\" \u0026\u0026 e2e-k8s.sh"
